...
import { createProduct } from 'app/store/product'
import { useEffect, useState } from 'react'
import { useHistory } from 'react-router-dom'
import { BiError, BiUpload } from 'react-icons/bi'
import { SubmitHandler, useForm, Controller } from 'react-hook-form'
import useFormPersist from 'react-hook-form-persist'
import { ColorOption, CommonOption } from 'app/types'
...
export function CreateProductPage() {
	...
	const [fileUploadedName, setFileUploadedName] = useState('Файл не загружен')
	...
	} = useForm<CreateProductFormFields>({
		mode: 'all'
	})

	useFormPersist('create-product-form', { watch, setValue })

	const onSubmit: SubmitHandler<CreateProductFormFields> = (data) => {
	...
	return (
		<C.HCWrapper>
			<F.ProductForm autoComplete='off' onSubmit={handleSubmit(onSubmit)}>
				<F.ProductTitle>Добавление товара</F.ProductTitle>
